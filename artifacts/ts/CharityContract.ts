...
export namespace CharityContractTypes {
  ...
  export interface CallMethodTable {
    raiseFund: {
      params: CallContractParams<{ moneyRaised: bigint }>;
    ...
    donateFunds: {
      params: CallContractParams<{ donation: bigint }>;
      result: CallContractResult<boolean>;
    };
    spendFund: {
  ...
  export interface SignExecuteMethodTable {
    raiseFund: {
      params: SignExecuteContractMethodParams<{ moneyRaised: bigint }>;
    ...
    donateFunds: {
      params: SignExecuteContractMethodParams<{ donation: bigint }>;
      result: SignExecuteScriptTxResult;
    };
    spendFund: {
...
export const CharityContract = new Factory(
  Contract.fromJson(
    ...
    "",
    "79ae5676459c487b32af3fd4330884e24b57379d688611573a63042f4e8d0da7",
    []
  )
);
